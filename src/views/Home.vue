  ...
  <div>
    ...
    >
      <div class="justify-around md:flex lg:flex-row">
        <MusicBox
          cover-art-url="/assets/coverArts/medium/cover-art.medium.avif"
          cover-art-placeholder="/assets/coverArts/small/cover-art.small.avif"
          release-type="Album"
          title="II"
          stream-url="https://ffm.to/bnthii"
        ></MusicBox>
        <MusicBox
          cover-art-url="/assets/coverArts/medium/debris-essence-bside.medium.avif"
          cover-art-placeholder="/assets/coverArts/small/debris-essence-bside.small.avif"
          release-type="Single"
    ...
    <Section
      ...
      class="bg-dragonfly bg-cover bg-center pb-10 text-white"
    >
      <div class="pb-4 text-xl uppercase tracking-widest text-white">
        Live at Dissonance Festival
      </div>
      <div class="flex justify-center align-middle">
        <iframe
          :width="isMobile ? 480 : isTablet ? 600 : 800"
    ...
    >
      <lazy-image
        src="/assets/backgrounds/medium/merch-bg.medium.avif"
        placeholder="/assets/backgrounds/small/merch-bg.small.avif"
        class="pt-20 drop-shadow-xl md:pt-0 lg:pt-0"
      />
      <router-link
        :to="{ name: 'Merch' }"
        class="absolute top-28 rounded-lg bg-red bg-cover py-4 px-6 font-medium uppercase text-white drop-shadow-md hover:bg-white hover:text-black md:top-48 md:py-6 md:px-12 md:text-xl lg:top-72 lg:py-6 lg:px-12 lg:text-xl"
